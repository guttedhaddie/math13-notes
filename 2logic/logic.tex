...
\begin{enumerate}\setcounter{enumi}{1}
  ...
  \end{minipage}\par
	...
	\item\label{ex:taut2} $\bigl(P\wedge(P\implies Q)\bigr)\Longrightarrow Q$ is a tautology.% This is essentially how we understand a direct proof: if $P$ is true and we have a correct argument $P\implies Q$, then $Q$ must also be true.
...
\begin{thm}{\emph{Elements}, Book IX, Prop.\,20}{}
	There are infinitely many prime numbers.
\end{thm}

\begin{proof}
Assume there are exactly $n$ primes $\lst p n$ and consider the integer $\Pi:=p_1\cdots p_n+1$.
...
Euclid does things slightly differently. Instead of a contradiction argument, he asserts that, given a finite list of primes, the number $\Pi$ is divisible by a \emph{new prime} not in his list.
...
% 	\end{enumerate}
  ...
  \end{enumerate}
	...
	\item Prove: For every positive integer $n$, $n^2+n+3$ is an odd integer greater than or equal to 5.\par
