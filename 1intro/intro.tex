...
\begin{itemize}%\itemsep0pt
	\item \href{https://richardhammack.github.io/BookOfProof/}{\emph{Book of Proof}}, Richard Hammack%, %3rd ed 
		%2018.
	\item \href{https://scholarworks.gvsu.edu/books/24/}{\emph{Mathematical Reasoning}}, Ted Sundstrom%, %3rd ed 
		%2020.
...
Notice the sleight of hand: a mathematical proof establishes truth only by reference to one or more \emph{definitions}.\footnote{%
