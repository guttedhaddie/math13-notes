...
\begin{enumerate}
  ...
  \begin{enumerate}
  	...
  	\item $17^{251}\cdot 23^{12}-19^{41}$ on division by 5.%\emph{Hint: $17\equiv 2$ and $2^2\equiv -1\pmod 5$.}
  	\item $12^{10}+2^{36}\cdot 18^{12}$ on division by 141.%\emph{Hint: what nice number is close to 141? Use a calculator to help with some of the sums.}
  \end{enumerate}
