...
\boldsubsubsection{Linear Diophantine Equations}

We return, as promised to the motivating problem of finding integer points on straight lines.

\begin{examples}{}{}
	\exstart (\ref{ex:euclidalg}, mk.\,III)\lstsp We saw that $(x_0,y_0)=(3,-5)$ solves $1260x+750y=30$ (equivalently $42x+25y=1$). Suppose $(x,y)$ is any other integer solution and observe that
	\[
	...
	\]
	\begin{enumerate}\setcounter{enumi}{1}
	  \item (\ref{ex:bezout2}, cont)\lstsp We saw that $(x,y)=(7,-11)$ solves $123x+78y=3=\gcd(123,78)$
	  \begin{enumeratea}
...
This method works for all solvable linear Diophantine equations.
