...
Recall that in Section \ref{sec:func1}, we can defined the \emph{preimage} of a subset $V\subseteq B$ under a function $f:A\to B$ by
...
\subsubsection*{\bf The Canonical Map}
