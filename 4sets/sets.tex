...
In this section we construct new sets from old, modeled precisely on the logical concepts of \emph{and, or,} and \emph{not.} For the duration of this section, suppose that $\cU$ is some \emph{universal set,} of which every set mentioned subsequently is a subset.\footnote{This is necessary so that the definitions to come made using set-builder notation really define sets.}\par


\begin{defn}{Complements}{}
	...
	\begin{center}
		\begin{tabular}{c}
			\includegraphics[scale=1]{sets-05-venncomp}\\
			$\comp A$: everything not in $A$
		\end{tabular}
		\qquad\qquad
		\begin{tabular}{c}
			\includegraphics[scale=1]{sets-06-vennrelcomp}\\
